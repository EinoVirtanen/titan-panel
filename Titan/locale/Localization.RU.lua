...
function TitanLocalizeRU() 
  ...
  TITAN_PANEL_SLASH_STRING11 = LIGHTYELLOW_FONT_COLOR_CODE.."Для помощи по BonusScanner, введите : |cffffffff/bscan";
	...
	TITAN_BAG_SHARD_BAG_NAMES = {"Мешок душ","Малая сума душ","Коробка душ","Сумка из ткани Скверны","Сумка из сердцевинной ткани Скверны","Черная сумка теней"};
	TITAN_BAG_AMMO_POUCH_NAMES = {"Колчан из шкуры копытня", "Колчан из шкуры ворга", "Древняя перетянутая жилами ламина", "Колчан тысячи оперений", "Колчан из узловатой кожи", "Колчан из шкуры гарпии", "Колчан Риббли", "Колчан быстрой тетивы", "Тяжелый колчан", "Колчан Ночного Дозора", "Охотничий колчан", "Средний колчан", "Колчан из тонкой кожи", "Небольшой колчан", "Легкий колчан", "Подсумок контрабандиста", "Подсумок из узловатой кожи", "Подсумок из чешуи дракона Пустоты", "Нагрудный патронташ из кожи гнолла", "Нагрудный патронташ Риббли", "Подсумок из плотной кожи", "Подсумок из толстой кожи", "Нагрудный патронташ Ночного Дозора", "Средний патронташ", "Охотничья сумка для боеприпасов", "Небольшой кожаный подсумок", "Небольшой патронташ", "Небольшой подсумок"};
	TITAN_BAG_PROF_BAG_NAMES = {"Зачарованный мешочек из магической ткани","Зачарованная сумка из рунной ткани","Большая сумка зачаровывателя","Сумка зачаровывателя","Сумка из чароткани","Кориевый ящик с инструментами","Ящик для инструментов из оскверненного железа","Тяжелый ящик с инструментами","Мешочек для самоцветов","Сумка для драгоценностей","Укрепленная шахтерская сумка","Шахтерский мешок","Сумка кожевника","Сумка Многих шкур","Мешочек для трав","Сумка для трав Ценариона","Сумка Ценариона","Ботаническая сумка Микаа"};
