...
function TitanLocalizeRU() 
  ...
  TITAN_SKINS_RESET_DEFAULTS_DESC = "Resets the skin list to the default, build-in skins.";
	...
	TITAN_PERFORMANCE_ADDON_TOTAL_MEM_USAGE_LABEL = "Используется памяти аддонами:";
	TITAN_PERFORMANCE_ADDON_TOTAL_CPU_USAGE_LABEL = "Использование CPU:";
	...
	TITAN_PERFORMANCE_TOOLTIP_HINT = "Совет: Для сжатия/очистки памяти нажмите ЛКМ.";
