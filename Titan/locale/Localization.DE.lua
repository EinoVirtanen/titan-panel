...
if not L then return end
  ...
  L["TITAN_PANEL_SLASH_STRING11"] = LIGHTYELLOW_FONT_COLOR_CODE.."Fuer Hilfe zu BonusScanner eingeben: |cffffffff/bscan"; --SENSITY
	...
	L["TITAN_PANEL_VERSION_INFO"] = "|cffffffff vom "..RED_FONT_COLOR_CODE.."Titan Dev Team".." |cffffffff(HonorGoG, jaketodd422, joejanko, Lothayer, Tristanian, oXidFoX)"; --SENSITY
  ...
  L["TITAN_BAG_BACKPACK"] = "Rucksack";
	...
	L["TITAN_BAG_SHARD_BAG_NAMES"] = {"Seelenbeutel", "Kleiner Seelenbeutel", "Seelenkasten", "Teufelsstofftasche", "Kernteufelsstofftasche", "Schwarzschattentasche"};
