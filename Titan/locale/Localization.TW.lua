...
if not L then return end
	...
	-- slash command help
	   L["TITAN_PANEL_SLASH_STRING2"] = LIGHTYELLOW_FONT_COLOR_CODE.."輸入: |cffffffff/tp {reset | reset tipfont/tipalpha/panelscale/spacing}";
    ...
    -- general panel locale
	   L["TITAN_PANEL"] = "泰坦面版";
	   L["TITAN_PANEL_VERSION_INFO"] = "|cffffffff 作者 |cffBB33BBTitan 開發團隊".." |cffffffff(HonorGoG, jaketodd422, joejanko, Lothayer, Tristanian, oXidFoX, Yeachan)";
     ...
     L["TITAN_PANEL_MENU_LDB_SHOWN"] = "在選單中後綴附加仲介者";
     ...
     L["TITAN_PANEL_MENU_LSM_FONTS"] = "LibSharedMedia 字型"
	...
	-- localization strings for AceConfigDialog-3.0     
     ...
     L["TITAN_MEMORY_KBMB_LABEL"] = "KB/MB";
	   ...
	   L["TITAN_MONEY_FORMAT"] = "%d".."金"..", %d".."銀"..", %d".."銅";
